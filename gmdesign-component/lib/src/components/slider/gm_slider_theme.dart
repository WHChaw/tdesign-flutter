...
class GMSliderThemeData {
  ...
  })  : scaleTextStyle = scaleTextStyle ?? TextStyle(fontSize: 14, color: GMTheme.of(context).fontGyColor1),
        disabledScaleTextStyle =
            disabledScaleTextStyle ?? TextStyle(fontSize: 14, color: GMTheme.of(context).fontGyColor4),
        thumbTextStyle = thumbTextStyle ?? TextStyle(fontSize: 14, color: GMTheme.of(context).fontGyColor1),
        disabledThumbTextStyle =
            disabledThumbTextStyle ?? TextStyle(fontSize: 14, color: GMTheme.of(context).fontGyColor4),
        _sliderThemeData = sliderThemeData,
        _capsule = false;

  /// 胶囊型构建方法
  GMSliderThemeData.capsule({
    this.context,
    this.showScaleValue = false,
    this.showThumbValue = false,
    this.divisions,
  ...
  SliderThemeData normal(){
    return SliderThemeData(
      trackHeight: 4,
      activeTrackColor : GMTheme.of(context).brandNormalColor,
      inactiveTrackColor : GMTheme.of(context).grayColor4,
      disabledActiveTrackColor : GMTheme.of(context).brandDisabledColor,
      disabledInactiveTrackColor : GMTheme.of(context).grayColor2,
      activeTickMarkColor : GMTheme.of(context).brandNormalColor,
      inactiveTickMarkColor : GMTheme.of(context).grayColor4,
      disabledActiveTickMarkColor : GMTheme.of(context).brandDisabledColor,
      disabledInactiveTickMarkColor : GMTheme.of(context).grayColor2,
      thumbColor : Colors.white,
      disabledThumbColor : Colors.white,
      overlayShape : const GMNoOverlayShape(),
      tickMarkShape: GMRoundSliderTickMarkShape(themeData: this),
      thumbShape: GMRoundSliderThumbShape(themeData: this),
      trackShape: GMRoundedRectSliderTrackShape(themeData: this),
      rangeTickMarkShape :  GMRoundRangeSliderTickMarkShape(themeData: this),
      rangeThumbShape :  GMRoundRangeSliderThumbShape(themeData: this),
      rangeTrackShape :  GMRoundedRectRangeSliderTrackShape(themeData: this),
  ...
  SliderThemeData capsule(){
    return SliderThemeData(
      trackShape: GMCapsuleRectSliderTrackShape(themeData: this),
      tickMarkShape: GMCapsuleSliderTickMarkShape(themeData: this),
      thumbShape: GMCapsuleSliderThumbShape(themeData: this),
      rangeTrackShape: GMCapsuleRectRangeSliderTrackShape(themeData: this),
      rangeTickMarkShape: GMCapsuleRangeSliderTickMarkShape(themeData: this),
      rangeThumbShape: GMCapsuleRangeSliderThumbShape(themeData: this),
      activeTickMarkColor: GMTheme.of(context).grayColor3,
      inactiveTickMarkColor: GMTheme.of(context).grayColor3,
      disabledActiveTickMarkColor: GMTheme.of(context).grayColor3,
      disabledInactiveTickMarkColor: GMTheme.of(context).grayColor3,
      thumbColor : Colors.white,
      disabledThumbColor : Colors.white,
      trackHeight: 24,
      activeTrackColor : GMTheme.of(context).brandNormalColor,
...
///Slider轨道绘制
///
class GMRoundedRectSliderTrackShape extends SliderTrackShape with BaseSliderTrackShape {
  /// Create a slider track that draws two rectangles with rounded outer edges.
  const GMRoundedRectSliderTrackShape({required this.themeData});

  final GMSliderThemeData themeData;
...
///游标的绘制
///
class GMRoundSliderThumbShape extends SliderComponentShape {
  /// Create a slider thumb that draws a circle.
  const GMRoundSliderThumbShape({
  ...
  void paint(
    ...
    canvas.drawArc(
        ...
        Paint()
          ...
          ..strokeWidth = 1
          ..color = GMTheme.of().grayColor3);
  }
}

///系统用于绘制Overlay，这里不做绘制，只做slider的宽高计算
class GMNoOverlayShape extends SliderComponentShape {
  const GMNoOverlayShape();
...
/// 刻度绘制
///
class GMRoundSliderTickMarkShape extends SliderTickMarkShape {
  /// Create a slider tick mark that draws a circle.
  const GMRoundSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
...
///    rectangular edges
mixin GMBaseRangeSliderTrackShape {
...
/// The default shape of a [GMRangeSlider]'s track.
///
...
class GMRoundedRectRangeSliderTrackShape extends RangeSliderTrackShape with GMBaseRangeSliderTrackShape {
  ...
  const GMRoundedRectRangeSliderTrackShape({required this.themeData});
...
class GMRoundRangeSliderThumbShape extends RangeSliderThumbShape {
  /// Create a slider thumb that draws a circle.
  const GMRoundRangeSliderThumbShape({
    this.enabledThumbRadius = 10.0,
    this.disabledThumbRadius,
    this.elevation = 3.0,
...
class GMRoundRangeSliderTickMarkShape extends RangeSliderTickMarkShape {
  /// Create a range slider tick mark that draws a circle.
  const GMRoundRangeSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
...
///Slider轨道绘制
///
class GMCapsuleRectSliderTrackShape extends SliderTrackShape with BaseSliderTrackShape, GMCapsuleTrackShape {

  /// Create a slider track that draws two rectangles with rounded outer edges.
  const GMCapsuleRectSliderTrackShape({this.trackColorWhenShowScale = const Color(0xFFE7E7E7), required this.themeData});
...
///游标的绘制
///
class GMCapsuleSliderThumbShape extends SliderComponentShape {
  /// Create a slider thumb that draws a circle.
  const GMCapsuleSliderThumbShape({
    this.enabledThumbRadius = 10.0,
    this.disabledThumbRadius,
    this.elevation = 4.0,
    this.pressedElevation = 4.0,
...
/// 刻度绘制
///
class GMCapsuleSliderTickMarkShape extends SliderTickMarkShape {
  /// Create a slider tick mark that draws a circle.
  const GMCapsuleSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
...
///    the [RangeSlider]'s track.
///  * [RectangularRangeSliderTrackShape], for a similar track with sharp edges.
class GMCapsuleRectRangeSliderTrackShape extends RangeSliderTrackShape with GMBaseRangeSliderTrackShape {
  final Color trackColorWhenShowScale;
  ...
  /// The middle track segment is the selected range and is active, and the two
  /// outer track segments are inactive.
  const GMCapsuleRectRangeSliderTrackShape({this.trackColorWhenShowScale = const Color(0xFFE7E7E7), required this.themeData});
...
///  * [SliderTheme], which can be used to configure the thumb shapes of all
///    range sliders in a widget subtree.
class GMCapsuleRangeSliderThumbShape extends RangeSliderThumbShape {
  /// Create a slider thumb that draws a circle.
  const GMCapsuleRangeSliderThumbShape({
    this.enabledThumbRadius = 10.0,
    this.disabledThumbRadius,
    this.elevation = 3.0,
    this.pressedElevation = 3.0,
...
///  * [SliderTheme], which can be used to configure the tick mark shape of all
///    sliders in a widget subtree.
class GMCapsuleRangeSliderTickMarkShape extends RangeSliderTickMarkShape {
  /// Create a range slider tick mark that draws a circle.
  const GMCapsuleRangeSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
