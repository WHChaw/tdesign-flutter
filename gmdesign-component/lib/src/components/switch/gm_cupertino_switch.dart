...
///
/// {@tool dartpad}
/// This example shows a toggleable [GMCupertinoSwitch]. When the thumb slides to
...
/// {@tool snippet}
///
/// This sample shows how to use a [GMCupertinoSwitch] in a [ListTile]. The
...
class GMCupertinoSwitch extends StatefulWidget {
  ...
  /// {@template flutter.cupertino.GMCupertinoSwitch.dragStartBehavior}
  ...
  @override
  State<GMCupertinoSwitch> createState() => _GMCupertinoSwitchState();
...
class _GMCupertinoSwitchState extends State<GMCupertinoSwitch>
  ...
  @override
  void didUpdateWidget(GMCupertinoSwitch oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: Opacity(
        opacity:
            widget.onChanged == null ? _kGMCupertinoSwitchDisabledOpacity : 1.0,
        child: _GMCupertinoSwitchRenderObjectWidget(
          value: widget.value,
...
class _GMCupertinoSwitchRenderObjectWidget
    extends SingleChildRenderObjectWidget {
  const _GMCupertinoSwitchRenderObjectWidget({
    required this.child,
    required this.value,
  ...
  final Color thumbColor;
  final ValueChanged<bool>? onChanged;
  final _GMCupertinoSwitchState state;
  ...
  @override
  _RenderGMCupertinoSwitch createRenderObject(BuildContext context) {
    return _RenderGMCupertinoSwitch(
      value: value,
  ...
  void updateRenderObject(
      BuildContext context, _RenderGMCupertinoSwitch renderObject) {
    renderObject
      ..value = value
      ..activeColor = activeColor
      ..trackColor = trackColor
...
const double _kGMCupertinoSwitchDisabledOpacity = 0.5;
...
class _RenderGMCupertinoSwitch extends RenderConstrainedBox {
  _RenderGMCupertinoSwitch({
    required bool value,
    ...
    required _GMCupertinoSwitchState state,
  })  : _value = value,
  ...
  final _GMCupertinoSwitchState _state;
