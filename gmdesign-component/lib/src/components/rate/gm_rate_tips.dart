...
/// 评分提示组件
class GMRateTips extends StatelessWidget {
  const GMRateTips({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.all(GMTheme.of(context).spacer4),
      child: Row(
        children: [
          GestureDetector(
            onTap: () {
            ...
            child: Container(
              ...
              padding: EdgeInsets.only(left: GMTheme.of(context).spacer4, right: GMTheme.of(context).spacer4),
              child: Column(
                children: [
                  Row(
                    children: [
          ...
          if (allowHalf == true && isClick) SizedBox(width: GMTheme.of(context).spacer4),
          if (allowHalf == true && isClick)
            GestureDetector(
              onTap: () {
                if (allowHalf == true && isClick) {
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: index + 1 != activeValue ? GMTheme.of(context).whiteColor1 : GMTheme.of(context).grayColor3,
                  borderRadius: BorderRadius.circular(GMTheme.of(context).radiusSmall),
                ),
                padding: EdgeInsets.only(left: GMTheme.of(context).spacer4, right: GMTheme.of(context).spacer4),
                child: Column(
