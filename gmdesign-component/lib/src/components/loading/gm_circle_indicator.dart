...
class GMCircleIndicator extends StatefulWidget {
  const GMCircleIndicator({
    Key? key,
    this.color,
    this.size = 20.0,
    this.lineWidth = 3.0,
  ...
  @override
  _GMCircleIndicatorState createState() => _GMCircleIndicatorState();
}

class _GMCircleIndicatorState extends State<GMCircleIndicator>
  ...
  @override
  void didUpdateWidget(covariant GMCircleIndicator oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    var paintColor = widget.color ?? GMTheme.of(context).brandNormalColor;
    return Transform(
