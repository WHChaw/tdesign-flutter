...
class GMImage extends StatefulWidget {
  const GMImage({
    this.imgUrl,
    Key? key,
    this.type = GMImageType.roundedSquare,
    this.errorWidget,
    this.loadingWidget,
    this.width,
    this.height,
  ...
  @override
  State<StatefulWidget> createState() => _GMImageState();
}

class _GMImageState extends State<GMImage> {
  @override
  Widget build(BuildContext context) {
    switch (widget.type) {
      case GMImageType.clip:
      ...
      case GMImageType.roundedSquare:
        return Container(
            height: widget.height ?? 72,
            width: widget.width ?? 72,
