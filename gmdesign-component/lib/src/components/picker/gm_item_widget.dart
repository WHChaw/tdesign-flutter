...
class GMItemWidget extends StatefulWidget {
  ...
  @override
  _GMItemWidgetState createState() => _GMItemWidgetState();
}

class _GMItemWidgetState extends State<GMItemWidget> {
  /// 子项监听滚动，从而刷新自身的颜色
...
class ItemDistanceCalculator {
  ...
  double calculateFont(BuildContext context, double distance) {
    return GMTheme.of(context).fontBodyLarge!.size;
  }
}
