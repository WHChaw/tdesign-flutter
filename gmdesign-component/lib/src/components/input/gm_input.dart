...
enum GMInputType { normal, twoLine, longText, special, normalMaxTwoLine, cardStyle }

enum GMInputSize { small, large }

// 提供三种默认样式，也可以自定义decoration和上下文字。
enum GMCardStyle { topText, topTextWithBlueBorder, errorStyle }

class GMInput extends StatelessWidget {
  GMInput(
      {Key? key,
      this.width,
      this.textStyle,
      ...
      this.contentPadding,
      this.type = GMInputType.normal,
      this.size = GMInputSize.large,
      ...
      this.inputAction,
      GMInputSpacer? spacer,
      this.cardStyleBottomText,
      this.onTapOutside})
      :
        // assert(() {
        //   if (type == GMInputType.cardStyle) {
        ...
        // 最右侧间距16
        spacer = spacer ?? GMInputSpacer.generateDefault(),
  ...
  /// 输入框类型
  final GMInputType type;

  /// 卡片默认样式
  final GMCardStyle? cardStyle;

  /// 输入框规格
  final GMInputSize size;
  ...
  double getInputPadding() {
    switch (size) {
      case GMInputSize.small:
        return 12;
      case GMInputSize.large:
        return 16;
    }
  }
  ...
  Widget buildInputView(BuildContext context) {
    ...
    switch (type) {
      case GMInputType.normal:
        return buildNormalInput(context);
      case GMInputType.twoLine:
        return buildTwoLineInput(context);
      case GMInputType.special:
        return buildSpecialInput(context);
      case GMInputType.longText:
        return buildLongTextInput(context);
      case GMInputType.normalMaxTwoLine:
        return buildNormalInput(context);
      case GMInputType.cardStyle:
    ...
    return Stack(
      ...
      children: [
            ...
            children: <Widget>[
                    ...
                    Visibility(
                        ...
                        child: Padding(
                          ...
                          child: GMText(
                            '*',
                            maxLines: 1,
                            style: TextStyle(color: GMTheme.of(context).errorColor6),
                            font: GMTheme.of(context).fontBodyLarge,
                            fontWeight: FontWeight.w400,
                          ),
                        )),
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    GMInputView(
                      textStyle: textStyle ?? TextStyle(color: GMTheme.of(context).fontGyColor1),
                      readOnly: readOnly,
                      autofocus: autofocus,
                      ...
                      hintTextStyle: hintTextStyle ?? TextStyle(color: GMTheme.of(context).fontGyColor3),
                    ...
                    Visibility(
                      child: Padding(
                        ...
                        child: GMText(
                          ...
                          textColor: additionInfoColor ?? GMTheme.of(context).fontGyColor3,
                        ),
                      ),
                ...
                child: GestureDetector(
                    child: Container(
                      ...
                      child: Icon(
                        ...
                        color: clearBtnColor ?? GMTheme.of(context).fontGyColor3,
                      ),
                    ),
                    onTap: onClearTap ??
                        () {
        ...
        if (showBottomDivider)
          Visibility(
            visible: type != GMInputType.cardStyle,
            child: const GMDivider(
              margin: EdgeInsets.only(
                left: 16,
              ),
            ),
  ...
  BoxDecoration? _getCardStylePreDecoration(BuildContext context) {
    ...
    if (type == GMInputType.cardStyle) {
      switch (cardStyle) {
        case GMCardStyle.topText:
          cardStyleDecoration = BoxDecoration(
              color: Colors.white,
              border: Border.all(color: GMTheme.of(context).grayColor4),
              borderRadius: BorderRadius.circular(6));
          break;
        case GMCardStyle.topTextWithBlueBorder:
          cardStyleDecoration = BoxDecoration(
              color: Colors.white,
              border: Border.all(color: GMTheme.of(context).brandNormalColor, width: 1.5),
              borderRadius: BorderRadius.circular(6));
          break;
        case GMCardStyle.errorStyle:
          cardStyleDecoration = BoxDecoration(
              color: Colors.white,
              border: Border.all(color: GMTheme.of(context).errorColor6, width: 1.5),
              borderRadius: BorderRadius.circular(6));
          break;
        default:
          ...
          child: Column(
            children: [
              Text(
                cardStyleTopText ?? '',
                style: TextStyle(
                    fontSize: GMTheme.of(context).fontBodyMedium!.size,
                    height: GMTheme.of(context).fontBodyMedium!.height),
              ),
              const SizedBox(
                height: 8,
              ),
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                    ...
                    fontSize: GMTheme.of(context).fontBodySmall!.size,
                    height: GMTheme.of(context).fontBodySmall!.height),
              ),
            ],
          ),
        ),
