...
class GMNoticeBar extends StatefulWidget {
  const GMNoticeBar({
    super.key,
    this.context,
    this.style,
    ...
    this.theme = GMNoticeBarTheme.info,
    this.prefixIcon,
    this.suffixIcon,
    this.onTap,
    this.height = 22,
  ...
  @override
  State<StatefulWidget> createState() => _GMNoticeBarState();
}

class _GMNoticeBarState extends State<GMNoticeBar> {
  ScrollController? _scrollController;
  Timer? _timer;
  Size? _size;
  GMNoticeBarStyle? _style;
  ...
  void _init() {
    if (widget.style != null) {
      ...
      _style = GMNoticeBarStyle.generateTheme(context, theme: widget.theme);
    }
