...
class GMCalendarCell extends StatefulWidget {
  const GMCalendarCell({
    Key? key,
    this.tdate,
    this.format,
    required this.type,
  ...
  final double height;
  final Map<DateTime, List<GMDate?>> data;
  final double padding;
  final int rowIndex;
  final int colIndex;
  final List<GMDate?> dateList;

  @override
  _TDCalendarCellState createState() => _TDCalendarCellState();
}

class _TDCalendarCellState extends State<GMCalendarCell> {
  late List<GMDate?> list;
  var isToday = false;
  ...
  @override
  void didUpdateWidget(GMCalendarCell oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final cellStyle = GMCalendarStyle.cellStyle(context, widget.tdate!._type);
  ...
  Color? _getColor(GMCalendarStyle cellStyle, BoxDecoration? decoration) {
    positionOffset = 0;
    final next = _nextDay();
