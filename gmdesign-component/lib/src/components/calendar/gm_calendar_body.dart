...
class GMCalendarBody extends StatelessWidget {
  const GMCalendarBody({
    Key? key,
    this.maxDate,
    this.minDate,
    required this.type,
  ...
  final Widget Function(
      GMDate? date, List<GMDate?> dateList, Map<DateTime, List<GMDate?>> data, int rowIndex, int colIndex) builder;
  ...
  Widget build(BuildContext context) {
    ...
    final data = <DateTime, List<GMDate?>>{};
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return Column(
          ...
          children: [
            GMText(monthDateText, style: monthTitleStyle),
            ...List.generate(
  ...
  List<GMDate?> _getDaysInMonth(DateTime date, DateTime min, DateTime max) {
    ...
    final daysInMonth = List<GMDate?>.generate(preOffset, (index) => null);
