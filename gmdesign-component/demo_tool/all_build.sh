...
# divider
./bin/demo_tool generate --file ../lib/src/components/divider/gm_divider.dart --name TDDivider --folder-name divider --output ../example/assets/api/ --only-api
# fab
./bin/demo_tool generate --file ../lib/src/components/fab/gm_fab.dart --name TDFab --folder-name fab --output ../example/assets/api/ --only-api
# icon
./bin/demo_tool generate --file ../lib/src/components/icon/gm_icons.dart --name TDIcons --folder-name icon --output ../example/assets/api/ --only-api
# link
./bin/demo_tool generate --file ../lib/src/components/link/gm_link.dart --name TDLink --folder-name link --output ../example/assets/api/ --only-api
# text
./bin/demo_tool generate --file ../lib/src/components/text/gm_text.dart --name TDText,TDTextSpan,TDTextConfiguration --folder-name text --output ../example/assets/api/ --only-api


# 导航
# back_top
./bin/demo_tool generate --file ../lib/src/components/backtop/gm_backtop.dart --name TDBackTop --folder-name back-top --output ../example/assets/api/ --only-api
# drawer
...
# navbar
./bin/demo_tool generate --file ../lib/src/components/navbar/gm_nav_bar.dart --name TDNavBar,TDNavBarItem, --folder-name navbar --output ../example/assets/api/ --only-api
# sidebar
...
# tabbar
./bin/demo_tool generate --file ../lib/src/components/tabbar/gm_bottom_tab_bar.dart --name TDBottomTabBar,BadgeConfig,TDBottomTabBarTabConfig,TDBottomTabBarPopUpBtnConfig,TDBottomTabBarPopUpShapeConfig,PopUpMenuItem --folder-name tab-bar --output ../example/assets/api/ --only-api
# tabs
...
# input
./bin/demo_tool generate --file ../lib/src/components/input/gm_input.dart --name TDInput, TDInputSpacer --folder-name input --output ../example/assets/api/ --only-api
# picker
...
# radio
./bin/demo_tool generate --file ../lib/src/components/radio/gm_radio.dart --name TDRadioStyle,TDRadio,TDRadioGroup --folder-name radio --output ../example/assets/api/ --only-api --get-comments
# rate
./bin/demo_tool generate --file ../lib/src/components/rate/gm_rate.dart --name TDRate --folder-name rate --output ../example/assets/api/ --only-api
# search
./bin/demo_tool generate --file ../lib/src/components/search/gm_search_bar.dart --name TDSearchBar --folder-name search --output ../example/assets/api/ --only-api
# slider
./bin/demo_tool generate --file ../lib/src/components/slider/gm_slider.dart --name TDSlider,TDRangeSlider,TDSliderThemeData --folder-name slider --output ../example/assets/api/ --only-api
# stepper
./bin/demo_tool generate --file ../lib/src/components/stepper/gm_stepper.dart --name TDStepper --folder-name stepper --output ../example/assets/api/ --only-api
# switch
./bin/demo_tool generate --file ../lib/src/components/switch/gm_switch.dart --name TDSwitch --folder-name switch --output ../example/assets/api/ --only-api
# textarea
./bin/demo_tool generate --file ../lib/src/components/textarea/gm_textarea.dart --name TDTextarea --folder-name textarea --output ../example/assets/api/ --only-api --get-comments
# tree_select
./bin/demo_tool generate --file ../lib/src/components/tree/gm_tree_select.dart --name TDTreeSelect,TDSelectOption --folder-name tree-select --output ../example/assets/api/ --only-api
...
# 数据展示
# avatar
./bin/demo_tool generate --file ../lib/src/components/avatar/gm_avatar.dart --name TDAvatar --folder-name avatar --output ../example/assets/api/ --only-api
# badge
./bin/demo_tool generate --file ../lib/src/components/badge/gm_badge.dart --name TDBadge --folder-name badge --output ../example/assets/api/ --only-api
# cell
...
# empty
./bin/demo_tool generate --file ../lib/src/components/empty/gm_empty.dart --name TDEmpty --folder-name empty --output ../example/assets/api/ --only-api
# footer
# grid
# image
./bin/demo_tool generate --file ../lib/src/components/image/gm_image.dart --name TDImage --folder-name image --output ../example/assets/api/ --only-api
# imageViewer
...
# loading
./bin/demo_tool generate --file ../lib/src/components/loading/gm_loading.dart --name TDLoading --folder-name loading --output ../example/assets/api/ --only-api
# message
# noticeBar
...
# refresh
./bin/demo_tool generate --file ../lib/src/components/refresh/gm_refresh_header.dart --name TDRefreshHeader --folder-name pull-down-refresh --output ../example/assets/api/ --only-api --get-comments
# swipecell
...
# toast
./bin/demo_tool generate --file ../lib/src/components/toast/gm_toast.dart --name TDToast --folder-name toast --output ../example/assets/api/ --only-api


# 其他
# theme
./bin/demo_tool generate --file ../lib/src/theme/gm_theme.dart --name TDTheme,TDThemeData --folder-name theme --output ../example/assets/api/ --only-api
# radius
