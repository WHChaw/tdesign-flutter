...
///
/// GMSideBarCustomPage演示
///
class GMSideBarCustomPage extends StatefulWidget {
  const GMSideBarCustomPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return GMSideBarCustomPageState();
  }
}

class GMSideBarCustomPageState extends State<GMSideBarCustomPage> {
  var currentValue = 1;
