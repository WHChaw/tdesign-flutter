...
/// GMSideBarIconPage演示
///
class GMSideBarIconPage extends StatefulWidget {
  const GMSideBarIconPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return GMSideBarIconPageState();
  }
}

class GMSideBarIconPageState extends State<GMSideBarIconPage> {
  var currentValue = 1;
  ...
  Widget _buildIconSideBar(BuildContext context) {
    ...
    for (var i = 0; i < 20; i++) {
      list.add(
          SideItemProps(index: i, label: '选项', value: i, icon: GMIcons.app));
