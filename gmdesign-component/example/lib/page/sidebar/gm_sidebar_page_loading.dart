...
///
/// GMSideBarLoadingPage演示
///
class GMSideBarLoadingPage extends StatefulWidget {
  const GMSideBarLoadingPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return GMSideBarLoadingPageState();
  }
}

class GMSideBarLoadingPageState extends State<GMSideBarLoadingPage> {
  var currentValue = 1;
