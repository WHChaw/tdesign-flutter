...
class GMBadgePage extends StatefulWidget {
  const GMBadgePage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _GMBadgePageState();
}

class _GMBadgePageState extends State<GMBadgePage> {
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                const Positioned(
                  child: GMBadge(GMBadgeType.redPoint),
                  right: 0,
                  top: 0,
                )
              ],
        ...
        children: [
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                Container(
                  child: const Icon(GMIcons.notification),
                  decoration: BoxDecoration(
                      color: GMTheme.of(context).grayColor2,
                      borderRadius: BorderRadius.circular(
                          GMTheme.of(context).radiusDefault)),
                  height: 48,
                  width: 48,
                ),
                const Positioned(
