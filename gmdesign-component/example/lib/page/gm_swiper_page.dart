...
class GMSwiperPage extends StatelessWidget {
  const GMSwiperPage({Key? key}) : super(key: key);
  ...
  Widget _buildDotsSwiper(BuildContext context) {
    return Swiper(
      ...
      pagination: const SwiperPagination(
          ...
          builder: GMSwiperPagination.dots),
      itemBuilder: (BuildContext context, int index) {
        return const GMImage(assetUrl: 'assets/img/image.png',);
      },
    );
  }
  ...
  Widget _buildDotsBarSwiper(BuildContext context) {
    return Swiper(
      ...
      pagination: const SwiperPagination(
          alignment: Alignment.bottomCenter,
          builder: GMSwiperPagination.dotsBar),
      itemBuilder: (BuildContext context, int index) {
        return const GMImage(assetUrl: 'assets/img/image.png',);
      },
    );
  ...
  Widget _buildFractionSwiper(BuildContext context) {
    return Swiper(
      ...
      pagination: const SwiperPagination(
          alignment: Alignment.bottomCenter,
          builder: GMSwiperPagination.fraction),
      itemBuilder: (BuildContext context, int index) {
        return const GMImage(assetUrl: 'assets/img/image.png',);
      },
    );
  ...
  Widget _buildControlsSwiper(BuildContext context) {
    return Swiper(
      ...
      pagination: const SwiperPagination(
          ...
          builder: GMSwiperPagination.controls),
      itemBuilder: (BuildContext context, int index) {
        return const GMImage(assetUrl: 'assets/img/image.png',);
      },
    );
  ...
  Widget _buildCardsSwiper(BuildContext context) {
    return Swiper(
      ...
      itemCount: 6,
      loop: true,
      transformer: GMPageTransformer.margin(),
      pagination: const SwiperPagination(
          alignment: Alignment.center,
          builder: GMSwiperPagination.dots),
      itemBuilder: (BuildContext context, int index) {
  ...
  Widget _buildScaleCardsSwiper(BuildContext context) {
    return Swiper(
      ...
      itemCount: 6,
      loop: true,
      transformer: GMPageTransformer.scaleAndFade(),
      pagination: const SwiperPagination(
          alignment: Alignment.center,
          builder: GMSwiperPagination.dots),
      itemBuilder: (BuildContext context, int index) {
