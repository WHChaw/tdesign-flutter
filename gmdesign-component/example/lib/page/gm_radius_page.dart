...
/// 圆角示例页面
class GMRadiusPage extends StatelessWidget {
  const GMRadiusPage({Key? key}) : super(key: key);
  ...
  Widget _buildRadiusExtraLarge(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: GMTheme.of(context).brandNormalColor,
          borderRadius:
              BorderRadius.circular(GMTheme.of(context).radiusExtraLarge)),
    );
  }
  ...
  Widget _buildRadiusCircle(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: GMTheme.of(context).brandNormalColor,
          borderRadius:
              BorderRadius.circular(GMTheme.of(context).radiusCircle)),
    );
  }
}
