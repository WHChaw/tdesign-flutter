...
class GMSliderPage extends StatefulWidget {
  const GMSliderPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _GMSliderPageState();
}

class _GMSliderPageState extends State<GMSliderPage> {
  @override
  ...
  Widget _buildSingleHandle(BuildContext context) {
    return GMSlider(
      sliderThemeData: GMSliderThemeData(
        min: 0,
        max: 100,
      ),
      value: 10,
  ...
  Widget _buildCapsule(BuildContext context) {
    return Column(
      children: [
        GMSlider(
          sliderThemeData: GMSliderThemeData.capsule(
            showThumbValue: true,
            min: 0,
            max: 100,
            scaleFormatter: (value) => value.toInt().toString(),
