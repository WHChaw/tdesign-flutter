...
''';
      ...
      if(Platform.environment['FLUTTER_TEST'] == 'true'){
        ...
        // file:///Users/zflyluo/WorkSpace/flutter/tdesign_group/tdesign-mobile-flutter/gmdesign-component/example/main.dart
        var baseDir = Platform.script.toFilePath().split('/gmdesign-component')[0];
...
```dart
import 'package:gmdesign_flutter/gmdesign_flutter.dart';${_getExtraImport(title)}
```
...
import 'package:flutter_easyrefresh/easy_refresh.dart';''';
  ...
  static _getPageCode(String pageName) {
    if(pageName == 'td_side-bar_page'){
      return '''
[gm_sidebar_page.dart](https://github.com/Tencent/tdesign-flutter/blob/main/gmdesign-component/example/lib/page/sidebar/gm_sidebar_page.dart)

[gm_sidebar_page_anchor.dart](https://github.com/Tencent/tdesign-flutter/blob/main/gmdesign-component/example/lib/page/sidebar/gm_sidebar_page_anchor.dart)

[gm_sidebar_page_custom.dart](https://github.com/Tencent/tdesign-flutter/blob/main/gmdesign-component/example/lib/page/sidebar/gm_sidebar_page_custom.dart)

[gm_sidebar_page_icon.dart](https://github.com/Tencent/tdesign-flutter/blob/main/gmdesign-component/example/lib/page/sidebar/gm_sidebar_page_icon.dart)

[gm_sidebar_page_pagination.dart](https://github.com/Tencent/tdesign-flutter/blob/main/gmdesign-component/example/lib/page/sidebar/gm_sidebar_page_pagination.dart)''';
    }
    return '[$pageName.dart](https://github.com/Tencent/tdesign-flutter/blob/main/gmdesign-component/example/lib/page/$pageName.dart)';
  }
}
