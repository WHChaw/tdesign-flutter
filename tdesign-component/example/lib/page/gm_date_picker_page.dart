...
class GMDatePickerPage extends StatefulWidget {
  const GMDatePickerPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _GMDatePickerPageState();
}

class _GMDatePickerPageState extends State<GMDatePickerPage> {
  String selected_1 = '';
  String selected_2 = '';
  String selected_3 = '';
  String selected_4 = '';
  ...
  Widget buildYearMonthDay(BuildContext context) {
    return GestureDetector(
      onTap: (){
        GMPicker.showDatePicker(context, title: '选择时间',
            onConfirm: (selected) {
              setState(() {
  ...
  Widget buildWithoutTitle(BuildContext context) {
    return GestureDetector(
      onTap: (){
        GMPicker.showDatePicker(context, title: '',
            onConfirm: (selected) {
              setState(() {
