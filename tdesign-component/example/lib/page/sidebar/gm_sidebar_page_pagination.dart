...
///
/// GMSideBarPaginationPage演示
///
class GMSideBarPaginationPage extends StatefulWidget {
  const GMSideBarPaginationPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return GMSideBarPaginationPageState();
  }
}

class GMSideBarPaginationPageState extends State<GMSideBarPaginationPage> {
  var currentValue = 1;
