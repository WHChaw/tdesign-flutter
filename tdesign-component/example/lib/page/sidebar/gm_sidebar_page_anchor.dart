...
///
/// GMSideBarAnchorPage演示
///
class GMSideBarAnchorPage extends StatefulWidget {
  const GMSideBarAnchorPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return GMSideBarAnchorPageState();
  }
}

class GMSideBarAnchorPageState extends State<GMSideBarAnchorPage> {
  var currentValue = 1;
