...
class GMCollapsePage extends StatefulWidget {
  const GMCollapsePage({Key? key}) : super(key: key);

  @override
  GMCollapsePageState createState() => GMCollapsePageState();
}
...
class GMCollapsePageState extends State<GMCollapsePage> {
