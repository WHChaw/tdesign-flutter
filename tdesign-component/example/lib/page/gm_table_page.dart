...
class GMTablePage extends StatelessWidget {
  const GMTablePage({Key? key}) : super(key: key);
  ...
  Widget _basicTable(BuildContext context) {
    return GMTable(
      columns: [
        GMTableCol(title: '标题', colKey: 'title1', ellipsis: true),
        GMTableCol(title: '标题', colKey: 'title2'),
        GMTableCol(title: '标题', colKey: 'title3'),
        GMTableCol(title: '标题', colKey: 'title4')
      ],
      data: _getData(9),
    );
  }
  ...
  Widget _sortableTable(BuildContext context) {
    return GMTable(
      columns: [
        GMTableCol(title: '标题', colKey: 'title1', ellipsis: true, sortable: true),
        GMTableCol(title: '标题', colKey: 'title2', sortable: true),
        GMTableCol(title: '标题', colKey: 'title3', sortable: true),
        GMTableCol(title: '标题', colKey: 'title4', sortable: true)
      ],
      data: _getData(9),
    );
  }
        ...
        GMTableCol(
          ...
          cellBuilder: (BuildContext context) {
            return Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Icon(GMIcons.upload, color: GMTheme.of(context).brandNormalColor, size: 16),
                Icon(GMIcons.delete, color: GMTheme.of(context).brandNormalColor, size: 16),
              ],
            );
          },
        )
  ...
  Widget _fixedFirstColTable(BuildContext context) {
    return GMTable(
      columns: [
        GMTableCol(title: '标题', colKey: 'title1'),
        GMTableCol(title: '标题', colKey: 'title2'),
        GMTableCol(title: '标题', colKey: 'title3'),
        GMTableCol(title: '标题', colKey: 'title4', fixed: GMTableColFixed.left),
      ],
      data: _getData(10),
    );
  }
  ...
  Widget _horizontalScrollTable(BuildContext context) {
    return GMTable(
      columns: [
        GMTableCol(title: '标题', colKey: 'title1', width: 160),
        GMTableCol(title: '标题', colKey: 'title2', width: 160),
        GMTableCol(title: '标题', colKey: 'title3', width: 160),
      ],
      data: _getData2(),
    );
  }
  ...
  Widget _fixedScrollTable(BuildContext context) {
    return GMTable(
      columns: [
        GMTableCol(title: '标题', colKey: 'title1', width: 200),
        GMTableCol(title: '标题', colKey: 'title2', width: 160),
        GMTableCol(title: '标题', colKey: 'title3', width: 160),
        GMTableCol(
          title: '标题',
  ...
  Widget _centerTable(BuildContext context) {
    return GMTable(
      columns: [
        GMTableCol(title: '标题', colKey: 'title1', align: GMTableColAlign.center),
        GMTableCol(title: '标题', colKey: 'title2', align: GMTableColAlign.center),
        GMTableCol(title: '标题', colKey: 'title3', align: GMTableColAlign.center),
        GMTableCol(title: '标题', colKey: 'title4', align: GMTableColAlign.center)
      ],
      data: _getData(10),
    );
  }
