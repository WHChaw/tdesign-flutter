...
class GMNoticeBarPage extends StatelessWidget {
  const GMNoticeBarPage({super.key});
...
Widget _textNoticeBar(BuildContext context) {
  return const GMNoticeBar(context: '这是一条普通的通知信息');
}

@Demo(group: 'noticeBar')
Widget _scrollNoticeBar(BuildContext context) {
  return const GMNoticeBar(
...
Widget _iconNoticeBar(BuildContext context) {
  return const GMNoticeBar(
    context: '这是一条普通的通知信息',
    prefixIcon: GMIcons.error_circle_filled,
  );
}
...
Widget _entranceNoticeBar2(BuildContext context) {
  return const Padding(
    ...
    child: GMNoticeBar(
      context: '这是一条普通的通知信息',
      prefixIcon: GMIcons.error_circle_filled,
      suffixIcon: GMIcons.chevron_right,
    ),
  );
}
...
Widget _customNoticeBar(BuildContext context) {
  return GMNoticeBar(
    context: '这是一条普通的通知信息',
    prefixIcon: GMIcons.notification,
    suffixIcon: GMIcons.chevron_right,
    style: GMNoticeBarStyle(backgroundColor: GMTheme.of(context).grayColor3),
  );
}
...
Widget _successNoticeBar(BuildContext context) {
  return const GMNoticeBar(
    context: '这是一条普通的通知信息',
    prefixIcon: GMIcons.error_circle_filled,
    theme: GMNoticeBarTheme.success,
  );
}
...
Widget _warningNoticeBar(BuildContext context) {
  return const GMNoticeBar(
    context: '这是一条普通的通知信息',
    prefixIcon: GMIcons.error_circle_filled,
    theme: GMNoticeBarTheme.warning,
  );
}
...
Widget _cardNoticeBar(BuildContext context) {
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      color: GMNoticeBarStyle.generateTheme(context).backgroundColor,
...
Widget _tapNoticeBar(BuildContext context) {
  return GMNoticeBar(
    ...
    suffixIcon: GMIcons.chevron_right,
    onTap: (trigger) {
      GMToast.showText('tap:$trigger', context: context);
    },
  );
}
