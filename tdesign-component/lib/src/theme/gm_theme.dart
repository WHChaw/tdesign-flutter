...
class GMThemeData extends ThemeExtension<GMThemeData> {
  ...
  static GMThemeData defaultData({GMExtraThemeData? extraThemeData}) {
    _defaultThemeData ??= fromJson(
            _defaultThemeName, GMDefaultTheme.defaultThemeConfig,
  ...
  GMThemeData copyWithGMThemeData(
    ...
    return copyWith(name: name,colorMap: colorMap,fontMap: fontMap,radiusMap: radiusMap,fontFamilyMap: fontFamilyMap,shadowMap: shadowMap,marginMap: marginMap,extraThemeData: extraThemeData) as GMThemeData;
  }
  ...
  /// 创建空对象
  static GMThemeData _emptyData(String name,
      {GMExtraThemeData? extraThemeData}) {
