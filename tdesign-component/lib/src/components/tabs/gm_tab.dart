...
enum GMTabSize { large, small }

enum GMTabOutlineType {
  // 填充样式
  filled,
  // 胶囊样式
  capsule,
...
class GMTab extends Tab {
  ...
  /// 选项卡尺寸
  final GMTabSize size;

  ///选项卡样式
  final GMTabOutlineType outlineType;
  ...
  const GMTab(
      ...
      this.contentHeight,
      this.textMargin,
      this.size = GMTabSize.small,
      this.outlineType = GMTabOutlineType.filled,
      this.enable = true,
  ...
  Widget build(BuildContext context) {
    ...
    var isCapsuleOutlineType = outlineType == GMTabOutlineType.capsule;
