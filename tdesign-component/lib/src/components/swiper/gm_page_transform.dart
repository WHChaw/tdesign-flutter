...
/// GM默认PageTransformer
class GMPageTransformer extends PageTransformer {
  ...
  /// 普通margin的卡片式
  GMPageTransformer.margin({this.margin = 6.0})
      : fade = 1,
        scale = 1;

  /// 缩放或透明的卡片式
  GMPageTransformer.scaleAndFade({this.fade = 1, this.scale = 0.8})
      : margin = 0.0;

  GMPageTransformer({this.fade, this.scale, this.margin});
