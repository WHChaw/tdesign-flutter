...
class GMSwipeCellPanel {
  ...
  /// 操作组件列表
  final List<GMSwipeCellAction> children;

  /// 二次确认操作组件列表
  final List<GMSwipeCellAction>? confirms;

  /// 是否可通过拖动操作来移除 [GMSwipeCell] 组件
    ...
    return ActionPane(
      ...
      dismissible: _dragDismissible
          ? DismissiblePane(
              ...
              onDismissed: () async {
                await GMSwipeCell.of(context)?.close();
