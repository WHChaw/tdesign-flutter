...
class GMImageViewerWidget extends StatefulWidget {
  const GMImageViewerWidget({
    Key? key,
    this.closeBtn,
    this.deleteBtn,
  ...
  State<StatefulWidget> createState() {
    return _GMImageViewerWidgetState();
  }
}

class _GMImageViewerWidgetState extends State<GMImageViewerWidget> {
  int _index = 1;
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: GMTheme.of(context).whiteColor1),
                  ),
                ),
