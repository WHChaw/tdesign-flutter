...
export 'gm_indexes_anchor.dart';
export 'gm_indexes_list.dart';

/// 索引
class GMIndexes extends StatefulWidget {
  const GMIndexes({
    Key? key,
    this.indexList,
  ...
  @override
  _GMIndexesState createState() => _GMIndexesState();
}

class _GMIndexesState extends State<GMIndexes> {
  ...
  @override
  void didUpdateWidget(GMIndexes oldWidget) {
  ...
  List<Widget> _slivers() {
    ...
    return _indexList.map((e) {
      ...
      return SliverStickyHeader.builder(
        ...
        pinnedOffset: isPinnedOffset ? GMTheme.of(context).spacer8 + stickyOffset : stickyOffset,
        ...
        sliver: SliverToBoxAdapter(
          child: Builder(
            builder: (context) {
              ...
              return Padding(
                padding: isPinnedOffset ? EdgeInsets.only(top: GMTheme.of(context).spacer8) : EdgeInsets.zero,
