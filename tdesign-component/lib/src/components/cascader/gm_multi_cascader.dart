...
class GMMultiCascader extends StatefulWidget {
  /// 选择器标题
  final String? title;
  ...
  @override
  State<GMMultiCascader> createState() => _GMMultiCascaderState();
}

class _GMMultiCascaderState extends State<GMMultiCascader> with TickerProviderStateMixin {
...
class LeftLineWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: 16,
      child: CustomPaint(
        painter: LeftLinePainter(isShowTopLine: isShowTopLine, topLineColor: topLineColor ?? GMTheme.of(context).brandNormalColor, isCircleFill: isCircleFill),
      ),
    );
  }
}
