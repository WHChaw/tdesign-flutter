...
/// GMDialog手脚架
class GMDialogScaffold extends StatelessWidget {
  const GMDialogScaffold({
    Key? key,
    required this.body,
...
/// 弹窗标题
class GMDialogTitle extends StatelessWidget {
  const GMDialogTitle({
    Key? key,
    this.title,
...
/// 弹窗内容
class GMDialogContent extends StatelessWidget {
  const GMDialogContent({
    Key? key,
    this.content,
...
/// 弹窗信息
class GMDialogInfoWidget extends StatelessWidget {
  const GMDialogInfoWidget({
    Key? key,
    this.title,
    this.titleColor = Colors.black,
    this.titleAlignment,
        ...
        children: [
          Expanded(
            child: GMDialogButton(
              ...
              buttonTextColor: leftBtn.titleColor ?? GMTheme.of(context).brandNormalColor,
          ...
          Expanded(
            child: GMDialogButton(
              ...
              buttonTextColor: rightBtn.titleColor ?? GMTheme.of(context).whiteColor1,
        ...
        Row(
          ...
          children: [
            Expanded(
              child: GMDialogButton(
                buttonText: leftBtn.title,
                buttonTextColor: leftBtn.titleColor ?? GMTheme.of(context).fontGyColor1,
                buttonStyle: leftBtn.style,
                buttonType: leftBtn.type ?? GMButtonType.text,
                buttonTheme: leftBtn.theme,
                height: leftBtn.height,
            ...
            Expanded(
              child: GMDialogButton(
                buttonText: rightBtn.title,
                buttonTextColor: rightBtn.titleColor ?? GMTheme.of(context).brandNormalColor,
                buttonStyle: leftBtn.style,
                buttonType: leftBtn.type ?? GMButtonType.text,
                buttonTheme: leftBtn.theme ?? GMButtonTheme.primary,
                height: rightBtn.height,
                buttonTextFontWeight: rightBtn.fontWeight ?? FontWeight.w600,
                onPressed: () {
                  if(rightBtn.action != null){
...
/// 弹窗标题
class GMDialogButton extends StatelessWidget {
  const GMDialogButton({
    Key? key,
    this.buttonText,
  ...
  /// 按钮样式
  final GMButtonStyle? buttonStyle;

  /// 按钮类型
  final GMButtonType? buttonType;

  /// 按钮主题
  final GMButtonTheme? buttonTheme;
  ...
  Widget build(BuildContext context) {
    return GMButton(
      onTap: onPressed,
      style: buttonStyle,
      type: buttonType ?? GMButtonType.fill,
      theme: buttonTheme,
      text: buttonText,
