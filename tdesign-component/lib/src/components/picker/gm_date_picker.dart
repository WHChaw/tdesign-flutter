...
/// 时间选择器
class GMDatePicker extends StatefulWidget {
  const GMDatePicker(
      {required this.title,
  ...
  @override
  State<StatefulWidget> createState() => _GMDatePickerState();
}

class _GMDatePickerState extends State<GMDatePicker> {
                  ...
                  child: IgnorePointer(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        GMTheme.of(context).whiteColor1.withOpacity(0)
                      ])),
                    ),
                  ),
                ),
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
              ...
              child: GMText(widget.leftText ?? context.resource.cancel,
                  style: widget.leftTextStyle ??
                      TextStyle(
                          fontSize: GMTheme.of(context).fontBodyLarge!.size, color: GMTheme.of(context).fontGyColor2))),
          ...
          GestureDetector(
            ...
            child: GMText(
              ...
              style: widget.rightTextStyle ??
                  TextStyle(
                      fontSize: GMTheme.of(context).fontBodyLarge!.size, color: GMTheme.of(context).brandNormalColor),
            ),
          ),
        ],
      ),
