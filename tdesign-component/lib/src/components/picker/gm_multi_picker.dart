...
/// 项之间无联动的多项选择器
class GMMultiPicker extends StatelessWidget {
  /// 选择器标题
  final String? title;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          topLeft: Radius.circular(topRadius ?? GMTheme.of(context).radiusExtraLarge),
          topRight: Radius.circular(topRadius ?? GMTheme.of(context).radiusExtraLarge),
        ),
      ),
      child: Column(
              ...
              Padding(
                ...
                child: customSelectWidget ?? Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(GMTheme.of(context).radiusDefault))
                  ),
                ),
              ),
              // 列表
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                            ...
                            colors: [GMTheme.of(context).whiteColor1, GMTheme.of(context).whiteColor1.withOpacity(0)]
                        )
                    ),
                  ),
                ),
          ...
          GestureDetector(
              ...
              child: GMText(
                ...
                style: leftTextStyle?? TextStyle(
                  fontSize: GMTheme.of(context).fontBodyLarge!.size,
...
/// 多项联动选择器
class GMMultiLinkedPicker extends StatefulWidget {
  /// 选择器标题
  final String? title;
  ...
  @override
  State<StatefulWidget> createState() => _GMMultiLinkedPickerState();
}

class _GMMultiLinkedPickerState extends State<GMMultiLinkedPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          topLeft: Radius.circular(widget.topRadius ?? GMTheme.of(context).radiusExtraLarge),
          topRight: Radius.circular(widget.topRadius ?? GMTheme.of(context).radiusExtraLarge),
        ),
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
