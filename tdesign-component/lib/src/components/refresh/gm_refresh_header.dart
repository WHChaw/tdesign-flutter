...
class GMRefreshHeader extends Header {
  ...
  GMRefreshHeader({
    ...
    this.loadingIcon = GMLoadingIcon.circle,
  ...
  /// loading样式
  final GMLoadingIcon loadingIcon;
...
class TGIconHeaderWidgetState extends State<TGIconHeaderWidget> with TickerProviderStateMixin {
  ...
  Widget _buildLoading() => GMLoading(
    ...
    return Opacity(
      ...
      child: Container(
        ...
        child: constraint.maxHeight < 48.0
            ? Container()
            : GMText(context.resource.releaseRefresh,font: GMTheme.of(context).fontBodyMedium, textColor: GMTheme.of(context).fontGyColor3,),
