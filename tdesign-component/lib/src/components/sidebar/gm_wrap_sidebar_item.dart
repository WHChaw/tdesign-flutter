...
class GMWrapSideBarItem extends StatelessWidget {
  const GMWrapSideBarItem({
    Key? key,
    this.badge,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: style == GMSideBarStyle.normal ? renderNormalItem(context) : renderOutlineItem(context),
    );
  }
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: selectedTextStyle != null
                    ...
                    : (selectedColor ?? GMTheme.of(context).brandNormalColor),
