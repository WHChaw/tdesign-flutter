...
import 'gm_wrap_sidebar_item.dart';
...
class GMSideBar extends StatefulWidget {
  const GMSideBar({
    Key? key,
    this.value,
    this.defaultValue,
    ...
    this.style = GMSideBarStyle.normal,
    this.loading,
    this.loadingWidget,
  }) : super(key: key);
  ...
  /// 单项
  final List<GMSideBarItem> children;
  ...
  /// 控制器
  final GMSideBarController? controller;
  ...
  @override
  State<GMSideBar> createState() => _GMSideBarState();
}

class _GMSideBarState extends State<GMSideBar> {
  ...
  Widget build(BuildContext context) {
    if(_loading) {
      ...
      return SizedBox(
        ...
        child: const Align(
          child: GMLoading(icon: GMLoadingIcon.circle, size: GMLoadingSize.large),
        ),
      );
    }
